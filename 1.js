...
! function(t) {
	...
	e.clone = c, e.addLast = l, e.addFirst = d, e.removeLast = p, e.removeFirst = v, e.insert = h, e.removeAt = E, e.replaceAt = g, e.getIn = m, e.set = y, e.setIn = _, e.update = I, e.updateIn = b, e.merge = w, e.mergeDeep = T, e.mergeIn = O, e.omit = A, e.addDefaults = S;
	/*!
	 * Timm
	 *
	...
	function at(t) {
		...
		i && n.dispatch((0, m.rawDataImported)(i)), u.active || (n.dispatch((0, m.sessionInitialized)({
			...
			.className.indexOf(x) && (e.className += " ".concat(x)), n.getState()
	...
	function mt(t) {
		...
		r.dispatch((0, m.instanceAdded)((0, a.default)({
			...
			var n = t.getState()
				.ixParameters;
			t.dispatch((0, m.instanceStarted)(e, 0)), t.dispatch((0, m.animationFrameChanged)(performance.now(), n)), It(t.getState()
				.ixInstances[e], t)
		}(r, g) : (D({
			store: r,
			select: function(t) {
	...
	n(130), n(132), n(133), n(134), n(135), n(69), n(137), n(332), n(333), n(334), n(335), n(340), t.exports = n(341)
}, function(t, e, n) {
	"use strict";
	var r = n(3);
	...
	t.exports = function(t, e, n, E, g, m) {
		...
		if (O && !w) return m || (m = new r), y || f(t) ? i(t, e, n, E, g, m) : o(t, e, I, n, E, g, m);
		if (!(n & l)) {
					...
					switch (u) {
						...
						case ut:
							var g = lt[u],
								...
								I = n.aValue;
							Rt(t, g, o), a(t, g, I >= 1 ? "rgb(".concat(m, ",")
								.concat(y, ",")
								.concat(_, ")") : "rgba(".concat(m, ",")
								.concat(y, ",")
								.concat(_, ",")
								.concat(I, ")"));
							break;
	...
	function mt(t) {
		...
		return null == N || null == C ? [] : m.IS_BROWSER_ENV && u ? d(C)
			.filter(function(t) {
				return u.contains(t)
			}) : R === F ? d(N, C) : R === k ? p(d(N))
			.filter(E(C)) : R === G ? h(d(N))
			.filter(E(C)) : d(C)
	}
	var yt = /px/,
		_t = function(t, e) {
	...
	var r = n(4),
		...
		w = function(t, e) {
			var n = t,
				...
				b = I.duration,
				w = I.delay;
			null != p && (b = p), w = null != E ? E : w, c === g ? b = 0 : (u || y) && (b = w = 0);
			var T = e.payload.now;
			if (r && i) {
				var O = T - (a + w);
				if (s) {
	...
	t.exports = function(t, e, n) {
		...
		return e = o(e) || 0, r(n) && (E = !!n.leading, l = (g = "maxWait" in n) ? u(o(n.maxWait) || 0, e) : l, m = "trailing" in n ? !!n.trailing : m), w.cancel = function() {
	...
	var c, s, f, l = u(n(30)),
		...
		gt = (r = {}, (0, o.default)(r, x, vt()), (0, o.default)(r, R, ht()), (0, o.default)(r, S, vt()), (0, o.default)(r, A, ht()), (0, o.default)(r, D, vt(!1)), (0, o.default)(r, L, ht(!1)), (0, o.default)(r, N, vt()), (0, o.default)(r, C, ht()), (0, o.default)(r, U, {
			...
			handler: function(t) {
				...
				return T && (O > .95 || O < .05) && (O = Math.round(O)), (u !== h.EventBasedOn.ELEMENT || S || S !== a.elementHovered) && (O = f ? 1 - O : O, e.dispatch((0, g.parameterChanged)(A, O))), {
					elementHovered: S,
					clientX: v,
					clientY: m,
					pageX: _,
	...
	function a(t) {
		return Boolean(t.$el && t.$el.closest(o)
			.length)
	}
	...
	function f(t, e, n, r) {
		...
		function m(t, e) {
			return E = p(t) ? t : [t], f || m.build(),
				...
				.length > 1 && (f.items = f.empty, E.forEach(function(t, e) {
						var n = k("thumbnail"),
							r = k("item")
							.prop("tabIndex", 0)
							...
							.attr("role", "tab")
							.append(n);
						s(r, "show item ".concat(e + 1, " of ")
							.concat(E.length)), a(t) && r.addClass(i), f.items = f.items.add(r), N(t.thumbnailUrl || t.url, function(t) {
							t.prop("width") > t.prop("height") ? P(t, "wide") : P(t, "tall"), n.append(P(t, "thumbnail-image"))
						})
					}), f.strip.empty()
					.append(f.items), P(f.content, "group")), d(M(f.lightbox, "hide")
					.trigger("focus"))
				.add("opacity .3s")
				.start({
					opacity: 1
		...
		m.build = function() {
			return m.destroy(), (f = {
				...
				.attr("role", "button")
				.attr("aria-hidden", !0)
				.attr("aria-controls", "w-lightbox-view"), f.arrowRight = k("control right inactive")
				.attr("role", "button")
				.attr("aria-hidden", !0)
				.attr("aria-controls", "w-lightbox-view"), f.close = k("control close")
				.attr("role", "button"), s(f.arrowLeft, "previous image"), s(f.arrowRight, "next image"), s(f.close, "close lightbox"), f.spinner = k("spinner")
				...
				.attr("aria-valuetext", "Loading image"), f.strip = k("strip")
				.attr("role", "tablist"), l = new C(f.spinner, L("hide")), f.content = k("content")
				.append(f.spinner, f.arrowLeft, f.arrowRight, f.close), f.container = k("container")
				.append(f.content, f.strip), f.lightbox = k("backdrop hide")
				.append(f.container), f.strip.on("click", D("item"), w), f.content.on("swipe", T)
				.on("click", D("left"), _)
				.on("click", D("right"), I)
				.on("click", D("close"), b)
				.on("click", D("image, caption"), I), f.container.on("click", D("view"), b)
				.on("dragstart", D("img"), A), f.lightbox.on("keydown", S)
				.on("focusin", O), n(r)
				.append(f.lightbox), m
		}, m.destroy = function() {
			...
			if (t !== o) {
				...
				var s, p, v = o;
				return o = t, f.spinner.attr("aria-hidden", !1)
					.attr("aria-busy", !0)
					.attr("aria-valuenow", 0)
					.attr("aria-valuetext", "Loading image"), l.show(), N(e.html && (s = e.width, p = e.height, "data:image/svg+xml;charset=utf-8," + encodeURI('<svg xmlns="http://www.w3.org/2000/svg" width="' + s + '" height="' + p + '"/>')) || e.url, function(r) {
						if (t === o) {
							var i, a, s = k("figure", "figure")
								.append(P(r, "image")),
								p = k("frame")
								.append(s),
								h = k("view")
								...
								.append(p);
							e.html && ((a = (i = n(e.html))
								.is("iframe")) && i.on("load", g), s.append(P(i, "embed"))), e.caption && s.append(k("caption", "figcaption")
								.text(e.caption)), f.spinner.before(h), a || g()
						}

						function g() {
							if (f.spinner.attr("aria-hidden", !0)
								.attr("aria-busy", !1)
								.attr("aria-valuenow", 100)
								.attr("aria-valuetext", "Loaded image"), l.hide(), t === o) {
								var e = function(t, e) {
									return -1 === u(t - 1, e)
								}(t, E);
								...
								if (j(f.arrowRight, "inactive", r), F(f.arrowRight, r), r && f.arrowRight.is(":focus") && f.arrowLeft.focus(), f.view ? (d(f.view)
									.add("opacity .3s")
									.start({
										opacity: 0
									})
					...
					}), f.close.prop("tabIndex", 0), n(":focus")
					.addClass("active-lightbox"), 0 === g.length && (n("body")
						.children()
						.each(function() {
							n(this)
								.hasClass("w-lightbox-backdrop") || n(this)
								.is("script") || (g.push({
										node: n(this),
										hidden: n(this)
											.attr("aria-hidden"),
		...
		function S(t) {
			var e = t.keyCode;
			27 === e || x(e, "close") ? m.hide() : 37 === e || x(e, "left") ? m.prev() : 39 === e || x(e, "right") ? m.next() : x(e, "item") && n(":focus")
				.click()
		}
		...
		function R() {
			f && (f.strip.scrollLeft(0)
				.empty(), M(f.html, "noscroll"), P(f.lightbox, "hide"), f.view && f.view.remove(), M(f.content, "group"), P(f.arrowLeft, "inactive"), P(f.arrowRight, "inactive"), o = f.view = void 0, g.forEach(function(t) {
					var e = t.node;
	...
	r.define("lightbox", t.exports = function(t) {
		...
		function d(t) {
			var e, n, r = t.el.children(".w-json")
				.html();
			if (r) {
				try {
					r = JSON.parse(r)
		...
		return o.ready = o.design = o.preview = function() {
			n = a && r.env("design"), u.destroy(), i = {}, (e = c.find(l))
				.webflowLightBox(), e.each(function() {
					s(t(this), "open lightbox"), t(this)
		...
		function G(t, e) {
			if (!t.open) {
				...
				if (M(0, s), b.intro(0, s), r.redraw.up(), u || d.on("click" + E, t.outside), e) v();
					...
					if (t.overlay && (w = t.menu.prev(), t.overlay.show()
			...
			function c() {
				t.menu.height(""), f(t.menu)
					.set({
						x: 0,
						y: 0
					}), t.menu.each(k), t.links.removeClass(I), t.dropdowns.removeClass(m), t.dropdownToggle.removeClass(y), t.dropdownList.removeClass(_), t.overlay && t.overlay.children()
					.length && (w.length ? t.menu.insertAfter(w) : t.menu.prependTo(t.parent), t.overlay.attr("style", "")
	...
	.init({
		"events": {
			"e-3": {
				...
				"target": {
					"id": "6230164f12c0d82f8b87b877|0953dc18-cc76-ec36-c94f-f2299718dadf",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-11": {
				...
				"mediaQueries": ["main"],
				"target": {
					"id": "6230164f12c0d82f8b87b877|9bd78c21-b15c-2744-6b83-8ff6e00ffcb9",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-18": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6230164f12c0d82f8b87b877|e4e27aaf-2ad1-56bc-e1b8-acf5ee9e0ece",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-20": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6230164f12c0d82f8b87b877|0c3ac70c-b679-f256-f54e-680d3003c9f9",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-22": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6230164f12c0d82f8b87b877|ac857389-4c41-5f08-0bcf-a648691cdf51",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-26": {
				...
				"mediaQueries": ["main"],
				"target": {
					"id": "6230164f12c0d82f8b87b877|2a78aafc-3f12-e37f-afb0-a1dbc104fb50",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-28": {
				...
				"mediaQueries": ["main"],
				"target": {
					"id": "6230164f12c0d82f8b87b877|a8233ab9-bca7-7b9a-d31b-bd15a08d53f9",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-32": {
				...
				"mediaQueries": ["main"],
				"target": {
					"id": "6230164f12c0d82f8b87b877|e4e27aaf-2ad1-56bc-e1b8-acf5ee9e0ecd",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-34": {
				...
				"mediaQueries": ["main"],
				"target": {
					"id": "6230164f12c0d82f8b87b877|0c3ac70c-b679-f256-f54e-680d3003c9f8",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-36": {
				...
				"mediaQueries": ["main"],
				"target": {
					"id": "6230164f12c0d82f8b87b877|ac857389-4c41-5f08-0bcf-a648691cdf50",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-38": {
				...
				"mediaQueries": ["main"],
				"target": {
					"id": "6230164f12c0d82f8b87b877|a954141e-4a15-d7b8-0bc5-a3579310375b",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-40": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6230164f12c0d82f8b87b877|77ee7247-11b3-94d1-fa00-6ef5665bdc31",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-42": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6230164f12c0d82f8b87b877|e97ddd0d-8fcb-ce62-4c39-4af038930233",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-44": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6230164f12c0d82f8b87b877|d99cf440-835a-6982-dcf5-64ea5950af21",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-46": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6230164f12c0d82f8b87b877|6937ce1a-605f-b7ba-aa3b-e48260100c83",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-48": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6230164f12c0d82f8b87b877|6937ce1a-605f-b7ba-aa3b-e48260100cc5",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-50": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6230164f12c0d82f8b87b877|6937ce1a-605f-b7ba-aa3b-e48260100d07",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-52": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6230164f12c0d82f8b87b877|1e3bb5d2-cf07-cbad-b44f-ecb5ac8faf75",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-54": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6230164f12c0d82f8b87b877|a1b0aedf-c12f-b1d5-75a3-716da74d43fc",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-56": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "69633348-47c1-a52d-f63c-36c9d497cd0f",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-58": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "69633348-47c1-a52d-f63c-36c9d497cd13",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-60": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "69633348-47c1-a52d-f63c-36c9d497cd17",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-66": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6231c5ec779f64c909f85f72|8a9aa16f-bb62-6fba-fb57-d8a5a6705bd4",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-68": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6231c5ec779f64c909f85f72|8b6f297c-b6c8-55ec-9ab9-d10e23e85b67",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-70": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6a32d9c4-f73b-bf14-3ba1-b3b21486f4c8",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-72": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6a32d9c4-f73b-bf14-3ba1-b3b21486f4d0",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
			...
			"e-74": {
				...
				"mediaQueries": ["main", "medium", "small", "tiny"],
				"target": {
					"id": "6a32d9c4-f73b-bf14-3ba1-b3b21486f4cc",
					"appliesTo": "ELEMENT",
					"styleBlockIds": []
				},
				"targets": [{
		...
		"actionLists": {
			"a-3": {
					...
					"actionItems": [{
						...
						"config": {
							...
							"target": {
								...
								"selector": ".circle-letters-wrap",
								"selectorGuids": ["e5d0d39e-7697-4c8a-3504-bcdce6808b54"]
							},
							"zValue": 70,
							"xUnit": "DEG",
							"yUnit": "DEG",
						...
						"config": {
							...
							"target": {
								"useEventTarget": "CHILDREN",
								"selector": ".view-artwork-arrow-wrap",
								"selectorGuids": ["204a73b5-9c35-cb33-66da-7538c414f733"]
							},
							"globalSwatchId": "b672f684",
							"rValue": 43,
							"bValue": 97,
							"gValue": 169,
							"aValue": 1
						...
						"config": {
							...
							"target": {
								"useEventTarget": "CHILDREN",
								"selector": ".arrow-leg",
								"selectorGuids": ["18dfc5ec-51a9-ff09-ff01-6ea7e970de55"]
							},
							"globalSwatchId": "16599d6f",
							"rValue": 255,
							"bValue": 255,
						...
						"config": {
							...
							"target": {
								"useEventTarget": "CHILDREN",
								"selector": ".arrow-wrap",
								"selectorGuids": ["6c3ab46c-b826-2f7d-608b-3d38b1332e3b"]
							},
							"zValue": -34,
							"xUnit": "DEG",
							"yUnit": "DEG",
				...
				"createdOn": 1647325727383
			},
			"a-4": {
				"id": "a-4",
				"title": "View Artwork Hover Out",
				"actionItemGroups": [{
					"actionItems": [{
						"id": "a-4-n",
						"actionTypeId": "TRANSFORM_ROTATE",
			...
			"a-7": {
				"id": "a-7",
				"title": "Art Display Scroll Paarallax",
					...
					"continuousActionGroups": [{
						...
						"actionItems": [{
							...
							"config": {
								...
								"target": {
									"useEventTarget": "CHILDREN",
									"selector": ".art-grid-row",
									"selectorGuids": ["5970b5e2-450d-053f-1f3a-78dc3d525925"]
								},
								"widthValue": 110,
								"widthUnit": "%",
								"heightUnit": "PX",
							...
							"config": {
								...
								"target": {
									"useEventTarget": "CHILDREN",
									"selector": ".art-grid-row._2",
									"selectorGuids": ["5970b5e2-450d-053f-1f3a-78dc3d525925", "75e1fca2-96c0-a179-934b-adc1bf2c4785"]
								},
								"xValue": -6,
								"xUnit": "%",
								"yUnit": "PX",
				...
				"createdOn": 1647399969865
			},
			"a-8": {
				"id": "a-8",
				"title": "Art Display Hover",
				"actionItemGroups": [{
					"actionItems": [{
						"id": "a-8-n",
						...
						"config": {
							...
							"target": {
								"useEventTarget": "CHILDREN",
								"selector": ".art-display-container",
								"selectorGuids": ["f4bf3ccb-39b9-a352-a6db-e8b7b7e3e0f7"]
							},
							"value": 0,
							"unit": ""
						}
						...
						"config": {
							...
							"target": {
								"useEventTarget": "CHILDREN",
								"selector": ".art-display-info-wrapper",
								"selectorGuids": ["50458bff-25dd-4f82-e351-34636121ce30"]
							},
							"value": 0,
							"unit": ""
						}
				...
				"createdOn": 1647400398315
			},
			"a-9": {
				"id": "a-9",
				"title": "Art Display Hover Out",
				"actionItemGroups": [{
					"actionItems": [{
						"id": "a-9-n",
						"actionTypeId": "STYLE_OPACITY",
				...
				"actionItemGroups": [{
					"actionItems": [{
						...
						"config": {
							...
							"target": {
								"useEventTarget": "CHILDREN",
								"selector": ".arrow-wrap.link-block-arrow",
								"selectorGuids": ["6c3ab46c-b826-2f7d-608b-3d38b1332e3b", "131b1136-384b-015a-3e6d-1ca65a20be79"]
							},
							"zValue": -34,
							"xUnit": "DEG",
							"yUnit": "DEG",
				...
				"actionItemGroups": [{
					"actionItems": [{
						...
						"config": {
							...
							"target": {
								"useEventTarget": "CHILDREN",
								"selector": ".nav-link-hover-div",
								"selectorGuids": ["a1591714-21c7-2196-e686-3748143d9825"]
							},
							"widthValue": 0,
							"widthUnit": "%",
							"heightUnit": "PX",
